...
extension PlanOutOperation {
    /// Random experiment that filters through a given set of elements via randomization with weighted probability.
    ///
    /// The "success" probability (whether the array element should be included or not) is controlled through the "p" value, which must be between 0.0 - 1.0.
    /// The logic is very much like Bernoulli Trial – but for this operation, Bernoulli Trial is applied to each array elements and filtered out if it fails the trial.
