//
//  GreaterThanOrEqualToSpec.swift
//  PlanOutKitTests
//
...
final class GreaterThanOrEqualToSpec: QuickSpec {
    override func spec() {
        describe("GreaterThanOrEqualTo comparison operator") {
            let op = PlanOutOperation.GreaterThanOrEqualTo()
            ...
            context("when comparing numeric types") {
                ...
                it("returns true if left value equals to right value") {
                    let left = 2
                    let right = 2
                    var result: Bool?
            ...
            context("when comparing string types") {
                ...
                it("returns true if alphabetical order of left value equals to right value") {
                    let left = "abc"
                    let right = "abc"
                    var result: Bool?
